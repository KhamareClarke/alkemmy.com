...
import { Elixir } from '@/lib/category-api';
...
const ProductCard = ({ product, index }: { product: Elixir; index: number }) => {
  ...
  return (
    ...
    >
      <Link href={`/elixirs/${product.slug}`} className="block">
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-500">Elixir</span>
              </div>
