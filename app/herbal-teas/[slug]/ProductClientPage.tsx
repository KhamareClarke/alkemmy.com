...
import { HerbalTea } from '@/lib/category-api';
...
const ProductCard = ({ product, index }: { product: HerbalTea; index: number }) => {
  ...
  return (
    ...
    >
      <Link href={`/herbal-teas/${product.slug}`} className="block">
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-500">Herbal Tea</span>
              </div>
