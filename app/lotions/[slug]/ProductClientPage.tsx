...
import { Lotion } from '@/lib/category-api';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="mt-2 text-sm text-gray-500">
            ...
            <Link href="/lotions" className="hover:text-[#D4AF37]"> Lotions</Link> / 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-500">Lotion</span>
              </div>
        ...
        {relatedProducts.length > 0 && (
          <div className="mt-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Related Lotions</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {relatedProducts.map((relatedProduct) => (
                <Link key={relatedProduct.id} href={`/lotions/${relatedProduct.slug}`}>
                  <motion.div
                    whileHover={{ y: -5 }}
