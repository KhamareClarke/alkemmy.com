      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Complete Your Routine</h2>
            <p className="text-center text-gray-600 mb-12">Pair this product with these recommended items for best results</p>
