...
import { Shampoo } from '@/lib/category-api';
...
const ProductCard = ({ product, index }: { product: Shampoo; index: number }) => {
  ...
  return (
    ...
    >
      <Link href={`/shampoos/${product.slug}`} className="block">
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-500">Shampoo</span>
              </div>
